...
export function AiModelsSection() {
  ...
  const toggleAiProvider = useSettingsStore((s) => s.toggleAiProvider);
  ...
  return (
    <div className="mt-8 pt-6 border-t border-slate-800/80">
      ...
      {/* 隐私提示 banner: 深浅主题都用 amber 系,但通过双 token 保证:
          - 浅色下: amber-100 底 + amber-300 边 + amber-800/amber-900 文字, 对比度足够
          - 深色下: amber-500/10 半透明底 + amber-500/20 边 + amber-200 文字 */}
      <div
        className={cn(
      ...
      {modalOpen && <AiModelModal config={editing} onClose={() => setModalOpen(false)} />}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="mt-5 flex gap-2">
              ...
              <button
                onClick={() => {
                  deleteAiProvider(confirmDelete.id);
