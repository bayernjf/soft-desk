...
const CROSS_PLATFORM_RULES: CrossPlatformRule[] = [
  ...
  { exeBase: 'trae', publisherKeywords: ['bytedance', '字节跳动', 'trae'], bundleId: 'com.bytedance.trae' },
  { exeBase: 'traecn', publisherKeywords: ['bytedance', '字节跳动', 'trae'], bundleId: 'com.bytedance.trae' },
  { exeBase: 'traework', publisherKeywords: ['bytedance', '字节跳动', 'trae'], bundleId: 'com.bytedance.trae.work' },
  { exeBase: 'traeworkcn', publisherKeywords: ['bytedance', '字节跳动', 'trae'], bundleId: 'com.bytedance.trae.work' },
